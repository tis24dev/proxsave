...
🔒 The installer and `proxsave --upgrade` verify each release's signature before installing, so only authentic, untampered builds ever run ([details](./docs/PROVENANCE_VERIFICATION.md#release-signature-sha256sumssig)).
